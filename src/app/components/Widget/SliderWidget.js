...
import 'ba-components/vendors/react-animated-slider/react-animated-slider.css';
  ...
  <div>
    <Slider className="slider-wrapper short" autoplay={3000}>
      {content.map((item, index) => (
        ...
        >
          <div className="inner">
            <Typography variant="subheading" className={Type.light} gutterBottom>{item.title}</Typography>

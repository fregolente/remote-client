...
class EmailList extends React.Component {
  ...
  render() {
    ...
    const getCategory = cat => {
      switch (cat) {
        case 'updates':
          return (<span className={classNames(classes.iconOrange, classes.category)}><Flag /> Updates</span>);
        case 'social':
          return (<span className={classNames(classes.iconRed, classes.category)}><People /> Social</span>);
        case 'promos':
          return (<span className={classNames(classes.iconBlue, classes.category)}><LabelIcon /> Promos</span>);
        case 'forums':
          return (<span className={classNames(classes.iconCyan, classes.category)}><QuestionAnswer /> Forums</span>);
        default:
          return false;
      }
    };
          ...
          <div key={index.toString()} className={classes.item}>
            <div className="imageContainer col fileIconImg">
              <div className="downloadBtn">
                <IconButton color="secondary" component={Link} to={path} target="_blank">
                  <Download />
                </IconButton>
              </div>
            ...
            <section>
              <div className={classes.topAction}>
                <Typography className={classes.headMail}>
                  {mail.get('category') !== 'sent' && (<Fragment>From {mail.get('name')} to me</Fragment>)}
                </Typography>
              ...
              <div className={classes.emailContent}>
                <Typography variant="title" gutterBottom>{mail.get('subject')}</Typography>
    ...
    return (
      <main className={classes.content}>
        ...
        >
          ...
          />
          <MenuItem selected onClick={() => this.handleMoveTo(itemToMove, 'updates')}><Flag className={classes.iconOrange} /> Updates</MenuItem>
          <MenuItem onClick={() => this.handleMoveTo(itemToMove, 'social')}><People className={classes.iconRed} /> Social</MenuItem>
          <MenuItem onClick={() => this.handleMoveTo(itemToMove, 'promos')}><LabelIcon className={classes.iconBlue} /> Promos</MenuItem>
          <MenuItem onClick={() => this.handleMoveTo(itemToMove, 'forums')}><QuestionAnswer className={classes.iconCyan} /> Forums</MenuItem>
          <Divider />
          <MenuItem onClick={() => this.handleMoveTo(itemToMove, 'spam')}><ReportIcon /> Spam</MenuItem>
        </Menu>

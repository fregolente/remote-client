...
const Html = ({
  ...
  const preloaderStyle = {
    wrapper: '"position: fixed; top:0; left: 0; background: #fafafa; width: 100%; height: 100%; z-index: 1000"',
    preloader: '"position: absolute; top: calc(50% - 100px); left: calc(50% - 100px)"'
  };
  ...
  const spinner = '<div style=' + preloaderStyle.wrapper + '><img src="/images/spinner.gif" alt="spinner" style=' + preloaderStyle.preloader + ' /></div>';
  const content = component ? spinner + renderToString(component) : spinner;
  return (
    <html lang="en">
      <head>
        {head.base.toComponent()}
        <title>
          Boss Ultimate - Material Admin Dashboard
        </title>
        ...
        <meta name="theme-color" content="#512ea8" />
        <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500" rel="stylesheet" />
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet" />
        {/*
        <title>Boss Ultimate- Material Admin Dashboard</title>
        <meta name="description" content="" />
        */}
        {/* facebook */}
        <meta property="author" content="boss" />
